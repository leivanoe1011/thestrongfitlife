...
function Header () {
    ...
    return (
        <div className="row">
            ...
            <div className="col-sm-12 col-lg-5 offset-md-1 h-50">
                <img className="card-img-top snagHomeGymCard" src="..." alt=""/>
                <div className="card-body snagHomeGymCard">
                    <h5 className="card-body">Ready to Shatter Your Fitness Plateau?</h5>
                    <p className="card-text">Join the Beastmode Movement to Strengthen Your Mind and Transform Your Body without leaving the house.</p>
                    <a href="#" className="btn btn-primary snagHomeGym">SNAG MY HOME GYM MADE EASY GUIDE</a>
                </div>
            </div>
