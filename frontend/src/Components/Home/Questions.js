    ...
    <div className="container">
      <div className="row">
        <div className="col-sm-12 col-md-12 col-lg-12 text-center mb-2 mt-2  questionsCon">
          ...
          <p>
            Say hello to #beastmode, a simple way to achieve true body and mind
            transformation through live, virtual workouts.
          </p>
          <h4>What’s Beastmode?</h4>
          <p>
            Beastmode is a term I use to describe my all-in, no-nonsense method
            of training. My workouts utilize short bursts of intense activity to
            help you break through frustrating plateaus and propel you to the
